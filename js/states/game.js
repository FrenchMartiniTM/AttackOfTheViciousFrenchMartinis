...
//title screen
AttackOfTheViciousFrenchMartinis.Game = function(){};

AttackOfTheViciousFrenchMartinis.Game.prototype = {
  init: init,
  create: create,
  update: update,
  render: render
...
function init() {
  this.game = AttackOfTheViciousFrenchMartinis.game;
...
function create() {
    ...
    launchGreenEnemy(this.FACTOR_DIFFICULTY, this.greenEnemies, this.game);

    function launchGreenEnemy(factor_difficylty, greenEnemies, game) {
        //*/moved to main variables for modification of difficulty by score or other
        var MIN_ENEMY_SPACING = 1000 / factor_difficylty; //TODO: can work with difficulty
        var MAX_ENEMY_SPACING = 3000 / factor_difficylty; //TODO: can work with difficulty
        var ENEMY_SPEED = 100 * factor_difficylty; //TODO: can work with difficulty
...
function update() {
    ...
    //  Check collisions
    this.game.physics.arcade.overlap(this.player, this.greenEnemies, shipCollide, null, this); //TODO: Player live is set to false => GAME OVER
    this.game.physics.arcade.overlap(this.greenEnemies, this.bullets, hitEnemy, null, this);
    ...
    if (this.cursors.left.isDown) {
        this.player.body.velocity.x = -MAXSPEED; //without smootness of movement
